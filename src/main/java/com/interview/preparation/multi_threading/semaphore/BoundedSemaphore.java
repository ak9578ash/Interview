...
/**
 * BoundedSemaphore is a semaphore that has an upper bound on the number of permits it can issue or the number of threads that can access a shared resource at a time.
 */
@Slf4j
