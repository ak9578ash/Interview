...
import com.interview.preparation.low_level_design.bill_sharing.model.Split;
...
public class SplittingStrategyImpl implements SplittingStrategy{
    ...
    @Override
    public void bifurcateInExact(Expense expense, List<Split>amountList) throws ExpenseDoesNotExistsException, BadRequestException {
    ...
    @Override
    public void bifurcateInPercentage(Expense expense, List<User> userList, List<Double> userPercentage) {
