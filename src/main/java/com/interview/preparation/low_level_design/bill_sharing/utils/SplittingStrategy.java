...
public interface SplittingStrategy {
    ...
    void bifurcateInExact(Expense expense , List<Split>amountList) throws ExpenseDoesNotExistsException, BadRequestException;
    void bifurcateInPercentage(Expense expense , List<User>userList , List<Double>userPercentage);
}
